...
def get_filters():
    """
    Here are the steps performed by the Python program
    1-Asks user to specify a city, month, and day to analyze.

    2-What does the program return?
    ...
    while True:
        day = input("Which day of the week do you want to analyze?  (All, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday)  Enter day: ").lower()
